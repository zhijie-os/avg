...
class AVG:
    ...
    def __init__(self, cfg):
        ...
        self.regime_log_path = os.path.join(
            cfg.results_dir,
            f"{cfg.run_id}_regime_changes_aba_control_tiny_local_weighted_affine.log",
        )

        # Periodic detector trace for debugging/plotting.
        self.detector_trace_path = os.path.join(
            cfg.results_dir,
            f"{cfg.run_id}_detector_trace_aba_control_tiny_local_weighted_affine.csv",
        )
...
if __name__ == "__main__":
    ...
    pkl_fpath = os.path.join(
        ...
        (
            f"{args.env}"
            f"_aba_control_tiny_detector_local_weighted_affine"
