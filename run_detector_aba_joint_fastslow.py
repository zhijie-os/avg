...
class AVG:
    ...
    def __init__(self, cfg):
        ...
        # -------------------------------------------------
        # Fast-vs-slow predictor logging
        # -------------------------------------------------
        ...
        self.detector_trace_path = os.path.join(
            cfg.results_dir,
            f"{cfg.run_id}_fastslow_trace_aba_joint.csv",
        )
        ...
        with open(self.detector_trace_path, "w") as f:
            f.write(
                ...
                "warmup_remaining,predictor_nll\n"
            )
        ...
        # ensemble and follows it through an EMA in parameter
        # space. It therefore represents a longer-timescale
        # predictive model without storing replay data.
        # -------------------------------------------------
        ...
        # During warmup we still train both timescales and log
        # their scores, but downstream calibration should ignore
    ...
    def update(
        ...
        **kwargs,
        ...
        # =================================================
        # 4. Move the slow reference toward the UPDATED
        #    fast ensemble.
        #
        ...
        #
        # IMPORTANT:
        # There is intentionally NO CUSUM/detection decision
        # yet. This experiment first tests whether the basic
        # signal separates stationary vs changed regimes:
        #
        #   P(fast_wins | changed)
        #      >
        #   P(fast_wins | stationary)
        # =================================================
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=10_000,
        type=int,
        help="Startup steps excluded from fast-vs-slow calibration",
    )
    ...
    parser.add_argument(
        ...
        default=100,
        type=int,
        help="Write fast-vs-slow trace every N environment steps",
    )
