...
def main(args):
    ...
    # ---------------------------------------------------------
    # A -> B -> A wind regime
    # B applies a constant opposing x-axis force to the torso.
    # ---------------------------------------------------------
