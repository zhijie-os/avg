...
class LocalWeightedAffineMemory:
    ...
    A centered, well-supported query has leverage_ratio near 1. Values much
    larger than 1 indicate that the local samples are one-sided around the
    query, so the intercept prediction is weakly constrained.
    ...
    def __init__(self, cfg):
        ...
        with open(self.detector_trace_path, "w") as f:
            f.write(
                ...
                "query_leverage,query_leverage_ratio,geometry_ok,"
        ...
        self.detector_max_query_leverage_ratio = (
            cfg.detector_max_query_leverage_ratio
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=2.0,
        type=float,
        help="Maximum support-scaled query leverage; near 1 is centered, larger values indicate one-sided/extrapolative geometry",
    )
