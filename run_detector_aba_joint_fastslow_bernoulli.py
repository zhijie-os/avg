...
class AVG:
    ...
    def __init__(self, cfg):
        ...
        self.detector_trace_path = os.path.join(
            cfg.results_dir,
            f"{cfg.run_id}_fastslow_bernoulli_trace_aba_joint.csv",
        )
        ...
        with open(self.detector_trace_path, "w") as f:
            f.write(
                ...
                "bernoulli_llr,cusum_W,detector_active,regime_change,"
        ...
        with open(self.regime_log_path, "w") as f:
            f.write(
                "step,cusum_W,fast_slow_gap,fast_wins,bernoulli_llr\n"
            )
    ...
    def update(
        ...
        **kwargs,
        ...
        # =================================================
        # 2. Bernoulli likelihood-ratio CUSUM
        #
        ...
        if detector_active:
            ...
            if self.cusum_W >= self.detector_h:
                ...
                print(
                    ...
                    f"Bernoulli LLR={bernoulli_llr:.3f}"
                )
        ...
        # =================================================
        # 3. Update ONLY the fast ensemble on the current
...
if __name__ == "__main__":
    ...
    pkl_fpath = os.path.join(
        ...
        (
            f"{args.env}"
            f"_aba_joint_fastslow_bernoulli"
