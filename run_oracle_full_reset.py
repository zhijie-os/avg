"""Oracle full reset: HalfCheetah gravity 1.0 -> 0.7 -> 1.0.

At each true regime switch the actor and critic are reinitialized, the
optimizers recreated, and all normalization/TD statistics cleared, while the
global step counter continues: relearning the new MDP from scratch.

Usage:
    python3 run_oracle_full_reset.py
"""
...
def main():
    ...
    args.baseline = "oracle_full_reset"
